...
/// for initialization.
ANALOGSDK_API WootingAnalogResult initialise();
...
ANALOGSDK_API WootingAnalogResult set_device_event_cb(device_event cb);

/// Clear the device event callback
ANALOGSDK_API WootingAnalogResult clear_device_event_cb();